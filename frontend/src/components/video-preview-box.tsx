      ...
      <div class='p-4 md:p-5 m-2 flex flex-col gap-2'>
        ...
        <div class='flex flex-row gap-4 bg-transparent'>
          ...
          <div class='flex w-[40%] bg-white border shadow-sm rounded-3xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]'>
            <video
              onClick={() => { setCurrentExpandedVideo('https://lzpjglicedvhpzcyafkn.supabase.co/storage/v1/object/sign/Horoscope_Images/fox.mp4?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJIb3Jvc2NvcGVfSW1hZ2VzL2ZveC5tcDQiLCJpYXQiOjE3MDA5MTgxNDcsImV4cCI6MTcxMzg3ODE0N30.xfokMGg3FLO-mWn5u-dFtUQHaPSDfbDRh-aPXESQe8w&t=2023-11-25T13%3A15%3A48.212Z'); setShowModal(true) }}
              class='
                w-full
                max-w-full
                dark:border-gray-700
