...
const ListVideoBox: Component<{}> = (props) => {
  return (
      ...
      <div class='p-4 md:p-5 m-2 flex flex-col gap-2'>
        ...
        <div>
          <div class='relative flex gap-2'>
            <input type='text' id='hs-search-box-with-loading-5' name='hs-search-box-with-loading-5' class='py-3 px-4 pl-40 ps-11 block w-full border-[#D9D9D9] shadow-sm rounded-2xl border-[3px]  text-sm focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600' placeholder='Input search' />
            <div class='absolute inset-y-0 start-0 flex items-center pointer-events-none ps-4'>

              <span class='inline-flex items-center justify-center gap-4 py-1 ps-3 pe-2 rounded-xl text-xl ffitont-medium bg-[#E36E40] text-[#FFF] dark:bg-blue-800/30 dark:text-blue-500'>
                Volpe
                <button type='button' class='flex-shrink-0 h-4 w-4 inline-flex items-center justify-center rounded-full hover:bg-blue-200 focus:outline-none focus:bg-blue-200 focus:text-blue-500 dark:hover:bg-blue-900'>
              ...
              <svg class='flex-shrink-0 h-[1.6rem] w-[1.6rem] text-gray-400 ml-[13rem]' xmlns='http://www.w3.org/2000/svg' width='33' height='33' viewBox='0 0 33 33' fill='none'>
        ...
        <div class='inline-flex items-center mt-4 gap-x-2 text-xl font-semibold rounded-lg border border-transparent text-blackdisabled:opacity-50 disabled:pointer-events-none dark:text-blue-500 dark:hover:text-blue-400 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600'>
          ...
          <span class='inline-flex items-center justify-center gap-4 py-1 ps-3 pe-2 rounded-xl text-xl w- ffitont-medium bg-[#E36E40] text-[#FFF] dark:bg-blue-800/30 dark:text-blue-500'>
            Lupo
          </span>
          <span class='inline-flex items-center justify-center gap-4 p-1  rounded-xl text-xl w- ffitont-medium bg-[#E36E40] text-[#FFF] dark:bg-blue-800/30 dark:text-blue-500'>
            Rana
          </span>
          <span class='inline-flex items-center justify-center gap-4 py-1 ps-3 pe-2 rounded-xl text-xl w- ffitont-medium bg-[#E36E40] text-[#FFF] dark:bg-blue-800/30 dark:text-blue-500'>
            Bisci
