...
const GeneralModal: Component<{}> = (props) => {
  ...
  return (
    <div classList={{ hidden: !showModal() }}>
      ...
      <div class='absolute z-[9999999] top-[4%] left-[10%] w-[80%] h-50 flex flex-col bg-[#F2F2F2] border shadow-sm rounded-xl dark:bg-slate-900 dark:border-gray-700 dark:shadow-slate-700/[.7]'>
